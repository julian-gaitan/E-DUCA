...
if ($check_conn === true) {
    ...
    if (isset($idStudent) && isset($idSchedule)) {
        try {
            ...
            $sql = "DELETE FROM " . InscriptionPay::TABLE_NAME . " WHERE " . 
            InscriptionPay::FIELDS_MAP[$fk_idStudent] . "=:" . $fk_idStudent . " AND " . 
            InscriptionPay::FIELDS_MAP[$fk_idSchedule] . "=:" . $fk_idSchedule . ";";
